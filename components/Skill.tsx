...
export default function Skill({ directionLeft, skill }: Props) {
  return (
    <div className="relative flex cursor-pointer group">
        ...
        />
        <div className="absolute z-0 w-16 h-16 transition duration-300 ease-in-out rounded-full opacity-0 md:w-24 md:h-24 group-hover:opacity-80 group-hover:bg-white">
